...
import {IDropdownSettings, ListItem} from '../../resources/classes'
...
@Component({
  selector: 'base-cms-select-multiple',
...
export class SelectMultipleComponent implements ControlValueAccessor {
  ...
  _placeholder = 'Select'
  private _sourceDataType!: string // to keep note of the source data type. could be array of string/number/object
  ...
  constructor(private listFilterPipe: JfListFilterPipe, private cdr: ChangeDetectorRef) {}
